...
var Modal = /*#__PURE__*/React__default.forwardRef(function Modal(props, ref) {
  ...
  var modalComponent = React__default.createElement(react.Transition, {
    ...
    onClick: onClose
  }, showAttribution ? React__default.createElement("a", {
  ...
  }, "Powered by ", React__default.createElement(Logo, {
    className: "h-5"
  })) : null, React__default.createElement(react.Transition.Child, Object.assign({
    enter: "transition ease-out duration-150",
  ...
  var columns = React__default.useMemo(function () {
    return [{
      ...
      Cell: function Cell(_ref3) {
        ...
        if (!value) return React__default.createElement("span", null);
        var date = new Date(value);
        return React__default.createElement("span", null, months[date.getMonth()] + " " + date.getDay() + ", " + new Date(value).toLocaleTimeString([], {
          hour: '2-digit',
          minute: '2-digit'
        }));
      }
...
var SaveFileForm = function SaveFileForm(_ref) {
  ...
  var _useState = React.useState(file.name),
...
var FilesContainer = function FilesContainer(_ref) {
  ...
  return React__default.createElement(React.Fragment, null, React__default.createElement("div", {
  ...
  }), !fileToSave ? React__default.createElement(UploadButton, {
    file: fileToSave,
    consumerId: consumerId,
    jwt: jwt,
    folderId: folderId,
    ...
    appId: appId,
    onSuccess: mutate
  }) : null)), isLoading || isSearching ? React__default.createElement(LoadingTable, {
    isSearching: isSearching
  }) : null, React__default.createElement("div", Object.assign({}, getRootProps(), {
    className: "relative"
  }), React__default.createElement("input", Object.assign({}, getInputProps())), isDragActive || isUploading ? React__default.createElement("div", {
    className: "flex justify-center px-6 py-24 mt-4 border-2 border-gray-300 border-dashed rounded-md"
  }, isUploading ? React__default.createElement("div", {
    className: "flex flex-col items-center"
  }, React__default.createElement(Spinner, {
    className: "w-6 h-6 text-gray-500"
  }), progress !== null ? React__default.createElement("div", {
  ...
  }, React__default.createElement("span", null, "Drop here to upload to"), React__default.createElement("input", {
    id: "file-upload",
    name: "file-upload",
    type: "file",
    className: "sr-only"
  ...
  }, connection.name)), React__default.createElement("p", {
    className: "text-xs text-gray-500"
  }, folders.length ? "Folder: " + ((_folders = folders[folders.length - 1]) == null ? void 0 : _folders.name) : 'Root folder'))) : React__default.createElement("div", {
    className: "absolute inset-0 invisible w-full h-96 dropzone"
  })), !isLoading && !isSearching && hasFiles && !filesError && !isDragActive && !isUploading ? React__default.createElement(FilesTable, {
    data: searchMode && searchResults ? searchResults : files,
    handleSelect: handleSelect,
    isLoadingMore: isLoadingMore,
    searchMode: searchMode,
    uploadingMode: !!fileToSave
  }) : null, !isLoading && !isSearching && !hasFiles ? React__default.createElement("p", {
    className: "py-4 text-sm text-center text-gray-700"
  }, "No files found") : null, !isLoading ? React__default.createElement(SlideOver, {
    open: !!file
  }, React__default.createElement(FileDetails, {
    file: file,
    setFile: setFile,
    onSelect: onSelect
  })) : null, !isLoading && filesError ? React__default.createElement("p", {
    className: "mt-2 text-sm text-red-600"
  }, (filesError == null ? void 0 : filesError.message) || filesError) : null, (_files3 = files) != null && _files3.length && !isLoadingMore && !searchMode ? React__default.createElement("div", {
    className: "flex flex-row-reverse py-4 border-gray-200"
  }, React__default.createElement(reactWaypoint.Waypoint, {
    onEnter: function onEnter() {
      return nextPage();
    }
  })) : null, fileToSave && React__default.createElement(SaveFileForm, {
    file: fileToSave,
    appId: appId,
    consumerId: consumerId,
    jwt: jwt,
...
var SelectConnection = function SelectConnection(_ref) {
  ...
  return React__default.createElement("div", {
  ...
  }, React__default.createElement(react.Menu, null, function (_ref2) {
    var open = _ref2.open;
    return React__default.createElement(React__default.Fragment, null, React__default.createElement(react.Menu.Button, {
    ...
    }, React__default.createElement("div", null, !isLoading && (connection == null ? void 0 : connection.icon) && React__default.createElement("img", {
      ...
      className: "w-6 h-6"
    }), !isLoading && React__default.createElement("span", null, (connection == null ? void 0 : connection.name) || 'No integrations')), React__default.createElement("svg", {
      ...
      return React__default.createElement(react.Menu.Item, {
        ...
        }, connection.name)), React__default.createElement("span", {
          className: "inline-block w-2.5 h-2.5 mr-2 rounded-full ring-2 ring-white " + statusColor(connection)
        }));
      });
    }), React__default.createElement(react.Menu.Item, null, function (_ref4) {
...
var ModalContent = function ModalContent(_ref) {
  ...
  }, hasError ? React__default.createElement("span", {
    className: "mb-2 text-red-600"
  }, hasError) : React__default.createElement("span", {
    className: "text-gray-700 dark:text-gray-400"
  }, connection ? subTitle : 'No connector selected'))), React__default.createElement(SelectConnection, {
    jwt: jwt,
  ...
  }, connection ? React__default.createElement(ToastProvider, null, React__default.createElement(FilesContainer, {
    appId: appId,
    consumerId: consumerId,
    jwt: jwt,
    onSelect: onSelect,
  ...
  })) : !(callableConnections != null && callableConnections.length) && !isLoading ? React__default.createElement("div", {
...
var FilePicker = /*#__PURE__*/React.forwardRef(function FilePicker(_ref, ref) {
  var appId = _ref.appId,
      consumerId = _ref.consumerId,
      jwt = _ref.jwt,
  ...
  return React__default.createElement(React.Fragment, null, trigger ? React__default.cloneElement(trigger, {
    onClick: function onClick() {
      return setIsOpen(true);
    },
    ref: ref
  }) : null, React__default.createElement(Modal, {
    isOpen: isOpen,
...
//# sourceMappingURL=file-picker.cjs.development.js.map
